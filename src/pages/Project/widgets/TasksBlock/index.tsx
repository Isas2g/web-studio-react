      ...
      <div className={classes['tasks-container']}>
        ...
        <div className={classes['first-row']}>
          ...
          <Paragraph>
            ...
            должны быть реализованы, какой дизайн должен быть использован, и
            какие технологии должны быть использованы для создания сайта.
          </Paragraph>
        </div>
        <div className={classes['second-row']}>
          ...
          <Paragraph>
            После определения требований клиента, необходимо создать дизайн
            сайта, который будет соответствовать требованиям клиента и будущим
        ...
        <div className={classes['third-row']}>
          ...
          <Paragraph>
            ...
            приступить к его разработке и тестированию. Важно убедиться, что
            сайт функционирует корректно и отображается правильно на разных
